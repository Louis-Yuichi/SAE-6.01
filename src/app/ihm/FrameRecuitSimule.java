...
public class FrameRecuitSimule extends JFrame implements ActionListener
{
	...
	public FrameRecuitSimule(Controleur ctrl) {
		this.ctrl = ctrl;
		
		setTitle("Recuit Simulé — VRP");
		setSize(1400, 850);
		...
		main.add(panelNord(), BorderLayout.NORTH);
		main.add(panelCentre(), BorderLayout.CENTER);
		main.add(panelSud(), BorderLayout.SOUTH);
	...
	public void majTermine(double cout, String detail, long ms, double optimal) {
		SwingUtilities.invokeLater(() -> {
